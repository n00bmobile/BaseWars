...
ENT.PrintName = 'Diamond Printer' --The name of your custom printer.
ENT.BaseSpeed = 60 --How long the printer takes to print (in seconds).
ENT.BaseCapacity = 1920 --How much money the printer prints.
ENT.BaseStorage = 250000 --The starting storage capacity of the printer.
ENT.MaxPower = 150 --How much power the printer uses.
