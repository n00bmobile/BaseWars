...
--[Custom - ONLY USE WHOLE AND POSITIVE NUMBERS]--
ENT.PrintName = 'Dark Matter Printer' --The name of your custom printer.
ENT.BaseSpeed = 60 --How long the printer takes to print (in seconds).
ENT.BaseCapacity = 132000 --How much money the printer prints.
ENT.BaseStorage = 12000000 --The starting storage capacity of the printer.
ENT.MaxPower = 350 --How much power the printer uses.
