...
ENT.PrintName = 'Mobius Printer' --The name of your custom printer.
ENT.BaseSpeed = 60 --How long the printer takes to print (in seconds).
ENT.BaseCapacity = 79500 --How much money the printer prints.
ENT.BaseStorage = 6000000 --The starting storage capacity of the printer.
ENT.MaxPower = 300 --How much power the printer uses.
