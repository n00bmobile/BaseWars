...
ENT.PrintName = 'Nuclear Printer' --The name of your custom printer.
ENT.BaseSpeed = 60 --How long the printer takes to print (in seconds).
ENT.BaseCapacity = 2880 --How much money the printer prints.
ENT.BaseStorage = 500000 --The starting storage capacity of the printer.
ENT.MaxPower = 175 --How much power the printer uses.
