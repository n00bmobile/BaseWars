...
ENT.PrintName = 'Monolith Printer' --The name of your custom printer.
ENT.BaseSpeed = 60 --How long the printer takes to print (in seconds).
ENT.BaseCapacity = 372000 --How much money the printer prints.
ENT.BaseStorage = 24000000 --The starting storage capacity of the printer.
ENT.MaxPower = 450 --How much power the printer uses.
