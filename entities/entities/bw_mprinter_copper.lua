...
ENT.PrintName = 'Copper Printer' --The name of your custom printer.
ENT.BaseSpeed = 60 --How long the printer takes to print (in seconds).
ENT.BaseCapacity = 360 --How much money the printer prints.
ENT.BaseStorage = 15000 --The starting storage capacity of the printer.
ENT.MaxPower = 50 --How much power the printer uses.
