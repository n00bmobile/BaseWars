...
ENT.PrintName = 'Gold Printer' --The name of your custom printer.
ENT.BaseSpeed = 60 --How long the printer takes to print (in seconds).
ENT.BaseCapacity = 1080 --How much money the printer prints.
ENT.BaseStorage = 90000 --The starting storage capacity of the printer.
ENT.MaxPower = 100 --How much power the printer uses.
